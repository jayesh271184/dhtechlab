...
DATE=`date +%c`
NODE=CH1
echo -e "============================>>>${G} $NODE USAGE File Summary ${N}<<<==========================="
...
sh /u01/scripts/report_script/usa_Daily_Report.sh ${d1} ${m1} ${Y1}
sh /u01/scripts/report_script/usa_Daily_Report.sh ${d2} ${m2} ${Y2}
sh /u01/scripts/report_script/usa_Daily_Report.sh ${d3} ${m3} ${Y3}
sh /u01/scripts/report_script/usa_Daily_Report.sh ${d4} ${m4} ${Y4}
sh /u01/scripts/report_script/usa_Daily_Report.sh ${d5} ${m5} ${Y5}
sh /u01/scripts/report_script/usa_Daily_Report.sh ${d6} ${m6} ${Y6}
sh /u01/scripts/report_script/usa_Daily_Report.sh ${d7} ${m7} ${Y7}
