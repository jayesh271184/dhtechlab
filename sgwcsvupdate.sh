...
counterfile='/home/oracle/db_csv/sgwcounter.csv'
ctime=`date -d now '+%Y%m%d_%HH_%MM'`
newpath=/home/oracle/db_csv/sgwcounterfiles/
ctr=sgwcounter
underscore='_'
csv='.csv'
...
set serveroutput on;
set time on;
exec SP_SGWASNCSVREPORTBCKTBL_UPD;
commit;
exit
...
echo  `date`  >> /home/oracle/db_csv/sgwcounterbackup.csv
cat  /home/oracle/db_csv/sgwcounter.csv >> /home/oracle/db_csv/sgwcounterbackup.csv
/bin/cp $counterfile $newpath$newname
cat /dev/null > /home/oracle/db_csv/sgwcounter.csv
